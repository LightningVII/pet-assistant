...
class Articles extends Component {
  ...
  // static defaultProps: { destinations: ({ id: number; user: { name: string; avatar: string; }; saved: boolean; location: string; temperature: number; title: string; description: string; rating: number; reviews: number; preview: string; images: string[]; } | { ...; })[]; };
  componentDidMount() {
    // this.props.navigation.setOptions({
    //   header: props => <View style={{ height: 120 }}>
  ...
  render() {
    return (
      ...
      // style={{ marginTop: theme.sizes.padding + 86 }}
      >
